...
function default_1(server) {
    ...
    server.route({
        method: "GET",
        path: "/session/login/employer",
        options: {
            pre: [{
                    method: function () {
                        return configs.get("Roles").Auth_req.Employer_login;
                    },
                    assign: "role"
                }],
    ...
    //     server.route({
    //         method: "GET",
    //         path: "/session/invite/employee",
    //         options: {
    //             pre: [{
    //                 method: function() {
    //                     console.log("set role");
    //                     console.log(configs.get("Roles").Auth_req.Employee_invite);
    //                     return configs.get("Roles").Auth_req.Employee_invite;
    //                 },
    //                 assign: "role"
    //             }],
    //             handler: sessionController.inviteEmployee,
    //             // auth: "jwt",
    //             tags: ["api", "users"],
    //             description: "Login user.",
    //             // validate: {
